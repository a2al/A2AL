export default {
  ...
  'discover.search': '検索',
  'discover.search.failed': '検索を完了できませんでした',
  'discover.search.failed_hint': 'ネットワークインデックスが一時的に利用できません',
  ...
  'discover.resolve.unavailable': '有効な情報が見つかりません',
  'discover.resolve.unavailable_hint': '対象が未公開または期限切れの可能性があります',
  ...
  'connect.no_direct_path': 'このネットワークは直接接続を拒否しています',
  'connect.relay_required_hint': 'リレーサーバーの設定が必要です',
  'connect.peer_offline': '接続できません',
  'connect.unreachable_hint': '相手がオフラインかネットワーク不達の可能性があります',
  ...
  'daemon.unreachable': '未接続',
  'daemon.unreachable_hint': 'a2ald が起動しているか確認してください',
  'time.just_now': 'たった今',
  'time.ago': '{n}{unit}前',
  'time.in': '{n}{unit}後',
  'time.unit.second': '秒',
