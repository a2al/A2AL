export default {
  ...
  'agent.import.file_password_ph': 'パスワードを入力してEnterで復号',
  ...
  'node.token.none_hint': 'トークン未設定。ローカルアクセスは常に開放されています。API を loopback の外に公開する場合のみトークンを設定してください。',
  'node.token.paste_ph': 'トークンを貼り付け…',
